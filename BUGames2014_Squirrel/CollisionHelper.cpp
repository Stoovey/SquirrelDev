...
by: Alexander Jones
----------------------------*/
bool CollisionHelper::boxCollision(int x1, int y1, int w1, int h1, int x2, int y2, int w2, int h2){ //function call
...
by: Alexander Jones
----------------------------*/
bool CollisionHelper::circleCollision(int Cx1, int Cy1,int Cw1, int Ch1,int Cx2,int  Cy2,int Cw2,int Ch2){
